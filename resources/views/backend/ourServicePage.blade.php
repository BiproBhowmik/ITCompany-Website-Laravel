						...
						<div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-12">
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 258px;">Our Service Image</th>
							...
							<tbody>
								...
								<tr role="row" class="odd" id="commonId{{ $item->osId }}">
									...
									<td>{{ $item->osTitle }}</td>
									<td>{{ $item->osDisc }}</td>
									<td><img width="30%" src="{{ Storage::url($item->osPho)}}" alt="image"></td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form enctype="multipart/form-data" action="{{ route('ajaxAddOurSer') }}" method="POST" id="commonAddForm">
					@csrf
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<label for="langName">Our Service Image</label>
...
<div class="modal fade" id="commonUpdateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form enctype="multipart/form-data" action="{{ route('ajaxUpdateOurSer') }}" method="POST" id="updateCommonAddForm">
					@csrf
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<label for="langName">Update Our Service Image</label>
